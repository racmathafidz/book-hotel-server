...
module.exports = {
    ...
    actionSignin: async (req, res)=>{
        try {
            ...
            if(!isPasswordMatch){
                req.flash('alertMessage', 'User yang anda masukkan tidak cocok')
                req.flash('alertStatus', 'danger')
                res.redirect('/admin/signin') 
            }
            req.session.user = {
    ...
    viewDashboard: async (req, res) => {
        try {
            ...
            res.render('admin/dashboard/view_dashboard', { title: "Staycation | Dashboard", user: req.session.user, member, booking, item })
        } catch (error) {
            res.redirect('/admin/dashboard')
        }
    ...
    viewBank: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus')
            const alert = { message: alertMessage, status: alertStatus }
            res.render('admin/bank/view_bank', { alert, bank, title: "Staycation | Bank", user: req.session.user })
        } catch (error) {
            req.flash('alertMessage', `${error.message}`)
            req.flash('alertStatus', 'danger')
    ...
    showImageItem: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus')
            const alert = { message: alertMessage, status: alertStatus }
            res.render('admin/item/view_item', { title: "Staycation | Image Item", alert, item, action: 'show image', user: req.session.user })
        } catch (error) {
            req.flash('alertMessage', `${error.message}`)
            req.flash('alertStatus', 'danger')
            res.redirect('/admin/item')
    ...
    showEditItem: async (req, res) => {
        try {
            ...
            const alertStatus = req.flash('alertStatus')
            const alert = { message: alertMessage, status: alertStatus }
            res.render('admin/item/view_item', { title: "Staycation | Image Item", alert, item, category, action: 'edit image' })
        } catch (error) {
            req.flash('alertMessage', `${error.message}`)
            req.flash('alertStatus', 'danger')
            res.redirect('/admin/item')
